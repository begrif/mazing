...
/* Sixth maze from Mazes for Programmers,
 * this is a random walk similar to hunt-and-kill, but uses
 * a stack to backtrack for a new cell during the hunt stage.
 *
 * Example maze:
 *
 * +---+---+---+---+---+---+---+---+---+---+
